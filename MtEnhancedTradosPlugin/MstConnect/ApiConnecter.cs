...
namespace MstTranslateConnect
{
    internal class ApiConnecter
    {
        ...
        internal string Translate(string sourceLang, string targetLang, string textToTranslate, string categoryId, string format)
        {
            ...
            {
                string errorResponse = ProcessWebException(e, MtEnhancedTradosPlugin.PluginResources.MsApiFailedToTranslateMessage);
                ...
                {//if the reason is that the token is expired
                    ...
                    throw new Exception(MtEnhancedTradosPlugin.PluginResources.MsApiCategoryIdErrorMessage);
